...
import type { IClientHeuristic } from "#foundation/shared/interfaces/index.js";

@Service()
export class ClientHeuristicFingerprint {
  /**
   * @param {string} userAgent
   * @returns {IClientHeuristic}
   */
  private extract(userAgent: string): IClientHeuristic {
